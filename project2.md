...
Request private messages - use a free email API SendGrid is one.

When they log-in add their status to online, from offline?

Search for other users who want to travel to the same location?
